...
Base URL: https://pages-ultimate-gate.preview.emergentagent.com/api
...
BASE_URL = os.getenv("NEXT_PUBLIC_BASE_URL", "https://pages-ultimate-gate.preview.emergentagent.com") + "/api"
