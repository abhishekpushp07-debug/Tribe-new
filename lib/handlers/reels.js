...
function sanitizeReel(reel, mediaAsset) {
  ...
  const resolvedPlayback = asset.playbackUrl || av['720p']?.url || av.faststart?.url || clean.playbackUrl || null
  ...
  return {
    ...
    hlsUrl: asset.hlsUrl || av.hls?.url || null,
    dashUrl: asset.dashUrl || av.dash?.url || null,
    ...
    // Frontend selection guide
    recommended: {
      dash: asset.dashUrl || av.dash?.url || null,
      hls: asset.hlsUrl || av.hls?.url || null,
      mp4: av['720p']?.url || av['480p']?.url || resolvedPlayback,
