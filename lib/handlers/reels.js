...
function sanitizeReel(reel) {
  ...
  return {
    ...clean,
    // Ensure CDN URL is primary
    playbackUrl: clean.playbackUrl || null,
    thumbnailUrl: clean.thumbnailUrl || null,
    posterFrameUrl: clean.posterFrameUrl || clean.thumbnailUrl || null,
    // Video playback metadata for smooth experience
    playbackMeta: {
      loop: true,
      preload: 'auto',
      playsInline: true,
