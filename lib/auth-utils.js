  ...
  const [authors, pages, mediaAssets] = await Promise.all([
    ...
    uniqueMediaIds.length > 0
      ? db.collection('media_assets').find(
          ...
          { projection: { _id: 0, id: 1, publicUrl: 1, playbackUrl: 1, hlsUrl: 1, thumbnailUrl: 1, posterFrameUrl: 1, thumbnailStatus: 1, playbackStatus: 1, width: 1, height: 1, duration: 1, mimeType: 1, storageType: 1, variants: 1 } }
        ).toArray()
      : [],
  ])
