...
### Base URL
```
https://tribe-backend-docs.preview.emergentagent.com
```

All API endpoints are prefixed with `/api`. Example:
```
GET  https://tribe-backend-docs.preview.emergentagent.com/api/healthz
GET  https://tribe-backend-docs.preview.emergentagent.com/api/tribes
POST https://tribe-backend-docs.preview.emergentagent.com/api/auth/register
```
...
Base URL: `https://tribe-backend-docs.preview.emergentagent.com`
