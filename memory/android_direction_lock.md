...
### Base URL
```
https://pages-ultimate-gate.preview.emergentagent.com
```

All API endpoints are prefixed with `/api`. Example:
```
GET  https://pages-ultimate-gate.preview.emergentagent.com/api/healthz
GET  https://pages-ultimate-gate.preview.emergentagent.com/api/tribes
POST https://pages-ultimate-gate.preview.emergentagent.com/api/auth/register
```
