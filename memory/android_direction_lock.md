...
```
GET  https://dev-hub-39.preview.emergentagent.com/api/healthz
GET  https://dev-hub-39.preview.emergentagent.com/api/tribes
POST https://dev-hub-39.preview.emergentagent.com/api/auth/register
```
