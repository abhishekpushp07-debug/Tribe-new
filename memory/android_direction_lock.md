...
```
GET  https://tribe-feed-debug.preview.emergentagent.com/api/healthz
GET  https://tribe-feed-debug.preview.emergentagent.com/api/tribes
POST https://tribe-feed-debug.preview.emergentagent.com/api/auth/register
```
