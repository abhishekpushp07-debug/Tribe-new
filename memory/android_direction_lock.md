...
### Base URL
```
https://tribe-handoff-v1.preview.emergentagent.com
```

All API endpoints are prefixed with `/api`. Example:
```
GET  https://tribe-handoff-v1.preview.emergentagent.com/api/healthz
GET  https://tribe-handoff-v1.preview.emergentagent.com/api/tribes
POST https://tribe-handoff-v1.preview.emergentagent.com/api/auth/register
```
...
Base URL: `https://tribe-handoff-v1.preview.emergentagent.com`
