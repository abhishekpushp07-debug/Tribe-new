...
### Base URL
```
https://realtime-standings-1.preview.emergentagent.com
```

All API endpoints are prefixed with `/api`. Example:
```
GET  https://realtime-standings-1.preview.emergentagent.com/api/healthz
GET  https://realtime-standings-1.preview.emergentagent.com/api/tribes
POST https://realtime-standings-1.preview.emergentagent.com/api/auth/register
```
...
Base URL: `https://realtime-standings-1.preview.emergentagent.com`
