...
### Base URL
```
https://b5-search-proof.preview.emergentagent.com
```

All API endpoints are prefixed with `/api`. Example:
```
GET  https://b5-search-proof.preview.emergentagent.com/api/healthz
GET  https://b5-search-proof.preview.emergentagent.com/api/tribes
POST https://b5-search-proof.preview.emergentagent.com/api/auth/register
```
...
Base URL: `https://b5-search-proof.preview.emergentagent.com`
